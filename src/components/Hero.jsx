...
const Hero = () => {
  return (
    <div className='py-[8%] px-[4%] w-full flex md:flex-row  flex-col-reverse items-center md:items-start md:justify-between border-b-2 border-black  bg-gradient-to-b from-neutral-50 to-amber-200 '>
     <div className=' md:w-[60%] font-manrope '>
        <h1 className=' font-extrabold text-2xl lg:text-5xl md:text-4xl leading-normal'>Speak Without Boundaries. <br />Stay Anonymous.</h1>
        ...
        <div className='flex gap-5 mt-10'>
          <Button className='py-5 px-14 text-md lg:text-xl md:text-lg bg-accent'>Get Started</Button>
